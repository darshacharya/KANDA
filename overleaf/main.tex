...
% \usepackage{booktabs}                   % removed — using \hline with full grid borders
\setlength{\arrayrulewidth}{0.5pt}         % visible cell borders
\renewcommand{\arraystretch}{1.3}          % row padding for bordered tables
\usepackage{longtable}                    % multi-page tables
\usepackage{array}
\usepackage{tabularx}
\usepackage{float}
\usepackage{enumitem}                     % custom lists
\usepackage{url}                          % breakable URLs/paths (must load before hyperref)
\makeatletter
...
\usepackage[numbers,sort&compress]{natbib} % numeric cites, sorted by year (newest first)
...
% Project metadata
\newcommand{\ProjectTitle}{A Multimodal Embodied Robot Agent Driven by Large Language Models for Hardware-Conscious Command Generation}
...
% Inject column headers into LoF and LoT files
\addtocontents{lof}{\protect\noindent\protect\makebox[1.5em][l]{\textbf{Sl. No.}}\protect\hfill\textbf{Title}\protect\hfill\textbf{Page No.}\par\vspace{6pt}}
\addtocontents{lot}{\protect\noindent\protect\makebox[1.5em][l]{\textbf{Sl. No.}}\protect\hfill\textbf{Title}\protect\hfill\textbf{Page No.}\par\vspace{6pt}}

% ---- Front Matter (roman numerals, first 5 pages empty) ----
\pagenumbering{roman}
\pagestyle{empty}
\input{chapters/00_prelims}
\clearpage
